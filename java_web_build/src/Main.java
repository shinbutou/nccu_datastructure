	...
	public static void main(String[] args) {
		...
		while (sc.hasNextLine()) {
			...
			try {
				...
				System.out.println("蝚砌���挾"+(time2-time1)/1000+"蝘�");		   //test line
				System.out.println(); 									   //test line
				...
				System.out.println("蝚砌��挾"+(time3-time2)/1000+"蝘�");		   //test line
				System.out.println();						   		   		   //test line
				...
				System.out.println("蝚砌��挾"+(time4-time3)/1000+"蝘�");		   //test line
				System.out.println("蝮賢"+(time4-time1)/1000+"蝘�");            //test line
			} 
